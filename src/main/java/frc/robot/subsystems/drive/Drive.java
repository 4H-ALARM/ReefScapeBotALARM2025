...
import frc.lib.constants.ModeConstants.Mode;
...
public class Drive extends SubsystemBase {
  ...
  public Drive(
      ...
      ModuleIO brModuleIO) {
    this.gyroIO = gyroIO;
    modules[0] = new Module(frModuleIO, 1, SwerveConstants.FrontRight);
    modules[1] = new Module(flModuleIO, 0, SwerveConstants.FrontLeft);
    modules[2] = new Module(brModuleIO, 3, SwerveConstants.BackRight);
    modules[3] = new Module(blModuleIO, 2, SwerveConstants.BackLeft);
